        ...
        <div className="max-w-3xl space-y-8 animate-slide-up">
          <div className="space-y-4">
            ...
            <h1 className="font-display text-5xl md:text-6xl lg:text-7xl font-bold text-foreground leading-tight">
              Drive Your Journey
              <span className="block text-primary">In Style</span>
            </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-8 animate-slide-up" style={{ animationDelay: "400ms" }}>
            {[
              ...
              { icon: Users, label: "Best Rates", desc: "Price guaranteed" },
            ].map(({ icon: Icon, label, desc }) => (
              <div key={label} className="flex items-center gap-4 p-4 rounded-xl bg-card/50 border border-border/50">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground">
            The Josh Tours <span className="text-primary">Difference</span>
          </h2>
