...
import { Mail, MapPin, Phone, Star, Code, Facebook, Instagram, Twitter } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Premium car rental services in Sri Lanka. Experience comfort, and reliability with our exceptional fleet.
            </p>
